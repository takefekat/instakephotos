...
public class ImageList360Activity extends Activity {

    // 表示する画像の名前（拡張子無し）
    private String[] members = new String[1000];
    private String cameraIpAddress;
    private ImageList360Activity.LoadObjectListTask sampleTask = null;
...
//    private ImageList360Activity.GetImageSizeTask getImageSizeTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                GLPhotoActivity.startActivityForResult(ImageList360Activity.this, cameraIpAddress, fileId, thumbnail, false);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == GLPhotoActivity.REQUEST_REFRESH_LIST) {
            ...
            sampleTask = new ImageList360Activity.LoadObjectListTask();
            sampleTask.execute();
        }
    }
